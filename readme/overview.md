...
> 최종 업데이트: 2026-07-24 (P2-3 배송 처리 완료 반영)
...
- **P2-3 배송 처리 완료**: 배송사+송장번호 입력 → 스마트택배 API(Supabase Edge Function + pg_cron) 연동으로 배송완료까지 자동 갱신. 실제 배송건 2건으로 종단 테스트 확인 완료
- 다음은 **P2-4 재고 차감 연동**
