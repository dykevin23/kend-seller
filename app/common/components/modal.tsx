    ...
    <Dialog open={open}>
      ...
      >
        <DialogHeader className="flex flex-row justify-between h-11 self-stretch px-4">
          ...
          <div
            className="aspect-square size-7 cursor-pointer text-foreground"
            onClick={onClose}
          >
            <svg
        ...
        {footer && (
          <DialogFooter className="fixed bottom-0 flex w-full h-18 p-4 justify-center items-center gap-1.5 shrink-0 bg-card border-t border-t-border">
            {footer}
          </DialogFooter>
        )}
      </DialogContent>
